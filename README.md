...
### 1. 首页 - 春节主题
> 默认春节主题，红色背景金色点缀，统计栏和抽奖界面一目了然

### 2. 设置菜单
> 点击右上角"设置"按钮，侧边菜单滑出，所有功能集中管理

### 3. 奖品配置
> 配置奖项等级、名称和数量，选择抽取模式（逐个/一次性）

### 4. 主题设置
> 5种精美主题可选，点击卡片即可实时预览

### 5. 逐个抽取模式
> 点击"开始滚动"人名快速切换，点击"停止"显示中奖者

### 6. 一次性抽取模式
> 点击"开始滚动"多人名同时闪动，点击"停止"一次性显示所有中奖者

### 7. 中奖名单
> 按奖项分组显示，支持导出CSV和TXT格式

### 8. 主题切换效果 - 金色华章
> 金色华章主题，高贵典雅，适合高端年会

**💡 提示**：截图需要手动添加到 `screenshots/` 目录
...
3. 使用截图工具（推荐使用系统自带或snipping tool）
4. 保存为PNG格式，命名参考：
   - `home-spring.png` - 春节主题首页
   - `settings-menu.png` - 设置菜单
   - `prize-config.png` - 奖品配置页
   - `theme-settings.png` - 主题设置页
   - `single-mode.png` - 逐个抽取模式
   - `batch-mode.png` - 一次性抽取模式
   - `results.png` - 中奖名单页
   - `theme-golden.png` - 金色主题效果

### 截图要点
- 展示主题特色（红金配色）
- 包含抽奖动画效果
- 显示完整的功能界面
- 分辨率建议：1920x1080或1280x720
